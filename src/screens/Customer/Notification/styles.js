...
export const styles = StyleSheet.create({
  ...
  backBtn: {
    ...
    height: 44,
    borderRadius: 22,
    backgroundColor: Theme.staticColors.card,
  ...
  filterBadgeText: {
    color: Theme.staticColors.subtext,
  ...
  unreadCard: {
    ...
    borderColor: 'rgba(46, 91, 255, 0.12)',
  ...
  invoiceSheet: {
    ...
    marginBottom: 20,
    borderTopWidth: 5,
    borderTopColor: Theme.staticColors.primary,
  },
  invoiceHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  ...
  demoToggleButtonInactive: {
    backgroundColor: 'rgba(255, 255, 255, 0.05)',
    borderWidth: 1,
    borderColor: 'rgba(255, 255, 255, 0.1)',
  },
  demoToggleButtonLabel: {
    color: '#fff',
  ...
  alertCtaButton: {
    ...
    elevation: 4,
    ...Platform.select({
      web: { boxShadow: `0px 4px 8px ${Theme.staticColors.primary}33` },
      default: {
  ...
  loyaltyCtaButton: {
    ...
    elevation: 4,
    ...Platform.select({
      web: { boxShadow: '0px 4px 8px rgba(168, 85, 247, 0.2)' },
      default: {
        shadowColor: '#A855F7',
        shadowOffset: { width: 0, height: 4 },
        shadowOpacity: 0.2,
  ...
  systemCtaButton: {
    ...
    elevation: 4,
    ...Platform.select({
      web: { boxShadow: '0px 4px 8px rgba(239, 68, 68, 0.2)' },
      default: {
        shadowColor: '#EF4444',
        shadowOffset: { width: 0, height: 4 },
        shadowOpacity: 0.2,
  ...
  systemInsuranceHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
    marginBottom: 12,
  },
  systemInsuranceTitle: {
    color: Theme.staticColors.warning,
    fontSize: moderateScale(15),
    fontWeight: 'bold',
  },
