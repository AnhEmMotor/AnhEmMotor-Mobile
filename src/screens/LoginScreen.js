      ...
      >
        ...
        >
          <Animated.View
            ...
            style={[styles.themeToggleContainer, { top: Math.max(insets.top, 20) + 10 }]}
          >
            <Pressable
              style={[
          ...
          >
            ...
            <View style={[styles.cardInner, { backgroundColor: colors.glassBg }]}>
              ...
              <View style={styles.optionsRow}>
                ...
                >
                  {rememberPassword ? (
                    <Eye size={moderateScale(18)} color={colors.primary} />
                  ) : (
                    <View
                      style={{
