...
export const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: Theme.colors.subtext, fontSize: moderateScale(12) },
  ...
  countText: { color: Theme.colors.subtext, fontSize: moderateScale(14) },
  ...
  filterText: { color: Theme.colors.primary, fontSize: moderateScale(13), fontWeight: '600', marginLeft: horizontalScale(6) },
  ...
  productPriceOpen: { color: Theme.colors.primary, fontSize: moderateScale(15), fontWeight: 'bold', textAlign: 'center' },
  
  emptyContainer: { alignItems: 'center', marginTop: verticalScale(100) },
  emptyText: { color: Theme.colors.subtext, fontSize: moderateScale(14) }
});
