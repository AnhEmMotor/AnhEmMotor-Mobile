...
const BOT_REPLIES = {
  'trả góp':
    'Để mua xe trả góp tại AnhEmMotor, bạn cần: CMND/CCCD, hộ khẩu, 3 tháng sao kê lương. Lãi suất từ 0% cho kỳ hạn 6 tháng. 😊',
  nhớt: 'Xe mới nên thay nhớt lần đầu sau 500-1000km để xả nhớt chạy roda. Sau đó mỗi 3.000km hoặc 3 tháng thay 1 lần nhé!',
  'bảo hành':
    'Phụ tùng chính hãng tại AnhEmMotor được bảo hành 6 tháng hoặc 5.000km. Chỉ áp dụng với lỗi sản xuất, không bao gồm hao mòn tự nhiên.',
  'tắt máy':
    'Khi xe tắt máy đột ngột: 1) Dắt xe vào lề, 2) Tắt công tắc ON/OFF 30 giây rồi khởi động lại, 3) Nếu không được hãy liên hệ hotline để được hỗ trợ kỹ thuật!',
};
  ...
  return (
    ...
    >
          ...
          <View style={[styles.botInfo, { flexDirection: 'row', alignItems: 'center' }]}>
            ...
            <View>
              ...
              >
                ...
                />
                <Text style={[styles.onlineText, { fontSize: 11, color: theme.colors.success }]}>
            ...
            >
              ...
              <Text
                style={[
                  ...
                  { fontSize: 12, marginLeft: 4, color: theme.colors.subtext },
                ]}
              >
                {q}
              </Text>
      ...
      >
        {messages.map((msg, index) => (
          <Animated.View
            ...
            style={[
              styles.msgWrapper,
              { flexDirection: 'row', alignItems: 'flex-end', marginBottom: theme.spacing.sm },
              msg.from === 'user' && styles.msgRight,
            ]}
          >
            {msg.from === 'bot' && (
              <View
            ...
            <View
              style={[
                styles.bubble,
                { maxWidth: '78%', borderRadius: 18, padding: theme.spacing.md },
                msg.from === 'user'
                  ? [
                      styles.userBubble,
                      {
                  ...
                  : [
                      styles.botBubble,
                      { borderBottomLeftRadius: 4, backgroundColor: theme.colors.card },
                    ],
              ]}
            >
              <Text
          ...
          <View style={styles.msgWrapper}>
            ...
            >
              <Text
                style={[
                  styles.typingDots,
                  { fontSize: 14, letterSpacing: 4, color: theme.colors.subtext },
                ]}
              >
                ● ● ●
              </Text>
      ...
      <View
        style={[
          styles.inputBar,
          { paddingHorizontal: theme.spacing.md, paddingBottom: 24, paddingTop: 8 },
        ]}
      >
        <GlassCard
          style={[
        ...
        >
          <TextInput
            style={[
              styles.textInput,
              { flex: 1, color: theme.colors.text, fontSize: 14, paddingVertical: 8 },
            ]}
            value={input}
