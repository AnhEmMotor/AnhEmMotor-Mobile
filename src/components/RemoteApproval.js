		...
		<View style={getStyles(activeColors).container}>
					...
					>
						...
						>
							...
							>
								<X
									color={
										item.status === "rejected" ? "#fff" : activeColors.subtext
									}
									size={18}
								/>
								<Text
									style={[
										...
										{ color: activeColors.subtext },
										item.status === "rejected" &&
											getStyles(activeColors).activeLabel,
									]}
								>
									Từ chối
								</Text>
							...
							>
								<Check
									color={
										item.status === "approved" ? "#fff" : activeColors.subtext
									}
									size={18}
								/>
								<Text
			...
			>
				<View style={getStyles(activeColors).totalRow}>
					<Text
						style={[
							getStyles(activeColors).totalLabel,
							{ color: activeColors.subtext },
						]}
					>
						Tổng cộng dự tính:
					...
					<Text
						style={[
							getStyles(activeColors).totalValue,
							{ color: activeColors.text },
						]}
					>
				...
				<TouchableOpacity
					style={[
						getStyles(activeColors).submitBtn,
