  ...
  return (
    <View style={styles.timelineItem}>
      <View style={styles.timelineLeft}>
        ...
        {!isLast && (
          <View style={[styles.timelineLine, { backgroundColor: activeColors.border }]} />
        )}
      </View>
        ...
        <View style={[styles.timelineCardOpen, { backgroundColor: activeColors.card }]}>
          <View style={styles.timelineHeader}>
            ...
            <View style={styles.timelineActions}>
              <Text style={[styles.timelineType, { color: activeColors.primary }]}>
                {item.type}
              </Text>
          ...
          <View style={[styles.timelineFooter, { borderTopColor: activeColors.border }]}>
            ...
            >
              ...
              <Text style={[styles.timelineTagText, { color: activeColors.subtext }]}>
                {item.km}
              </Text>
            </View>
