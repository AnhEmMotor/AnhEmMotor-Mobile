  ...
  return (
    <SafeAreaView style={[getStyles(theme).container, { backgroundColor: '#000' }]} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <ScalePress
          style={[getStyles(theme).flashBtn, { backgroundColor: theme.colors.border + '33' }]}
        >
      ...
      <View style={getStyles(theme).footer}>
        <Text style={[getStyles(theme).footerText, { color: theme.colors.subtext + '80' }]}>
          Mã định danh xe giúp bạn truy cập nhanh lịch sử bảo trì và thông tin sở hữu.
        </Text>
      </View>
    </SafeAreaView>
  );
