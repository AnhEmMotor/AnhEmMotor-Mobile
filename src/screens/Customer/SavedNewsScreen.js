	...
	return (
		...
		>
			<View style={getStyles(theme).header}>
				...
				<Text
					style={[getStyles(theme).headerTitle, { color: theme.colors.text }]}
				>
					Tin đã lưu
				</Text>
				<TouchableOpacity
				...
				{savedItems.length === 0 ? (
					<View style={getStyles(theme).emptyState}>
						...
						>
							<Text
								style={[
									getStyles(theme).exploreBtnText,
