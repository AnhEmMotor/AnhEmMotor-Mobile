...
export default function HomeDetailScreen({ route, navigation }) {
  ...
  const [comments, setComments] = useState([
    {
      id: '1',
      author: 'Thành Đạt',
      text: 'Bài viết hữu ích quá, cuối tuần này mình phải đi bảo dưỡng định kỳ ngay!',
      time: '10 phút trước',
      avatar:
    ...
    },
    {
      id: '2',
      author: 'Quốc Bảo',
      text: 'Cho mình hỏi cửa hàng có phủ bóng Nano cho xe phân phối lớn không ạ?',
      time: '30 phút trước',
      avatar:
  ...
  if (!activeItem) {
    return (
      <SafeAreaView
        style={[getStyles(theme).container, { backgroundColor: colors.background }]}
        edges={['top']}
      >
        <View style={getStyles(theme).centerContainer}>
          ...
          <TouchableOpacity
            ...
            style={[getStyles(theme).backIconBtn, { marginTop: 20, backgroundColor: colors.card }]}
          >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={getStyles(theme).voucherImageWrapper}>
            <Image
              source={{ uri: alertImg }}
              style={getStyles(theme).voucherImageBanner}
              resizeMode="cover"
            />
            <View
              style={[
                getStyles(theme).voucherImageOverlayBadge,
          ...
          <View style={[styles.alertHeader, { borderBottomColor: colors.border }]}>
            ...
            >
              {isCritical ? (
                ...
                <ShieldAlert color="#F59E0B" size={moderateScale(32)} />
              )}
            </View>
            <Text style={[getStyles(theme).detailTitle, { color: colors.text }]}>
              {activeItem.title || 'Bảo dưỡng định kỳ'}
            </Text>
            <View
              style={[
                styles.badge,
          ...
          <View style={styles.alertBody}>
            ...
            <View
              style={[
                getStyles(theme).vehicleInfoBox,
                {
            ...
            >
              <Text style={[getStyles(theme).vehicleInfoTitle, { color: colors.subtext }]}>
                Phương tiện cảnh báo:
              </Text>
              <Text style={[getStyles(theme).vehicleInfoName, { color: colors.primary }]}>
                Honda SH 125i
              </Text>
              <Text
                style={[
                  getStyles(theme).vehicleInfoPlate,
                  { color: colors.text, fontWeight: '600' },
                ]}
              >
                Biển số: 60-A1 555.55
              </Text>
            </View>
            {}
            {}
            ...
            >
              Xe của bạn đã đi được{' '}
              <Text style={{ fontWeight: 'bold', color: colors.primary }}>5,000 km</Text> kể từ lần
              bảo dưỡng định kỳ trước.
            </Text>
            ...
            <View style={getStyles(theme).alertRecommendations}>
              <Text style={[getStyles(theme).recommendationHeading, { color: colors.text }]}>
                Tại mốc 5,000km, để đảm bảo xe vận hành bốc, tiết kiệm xăng và đạt chuẩn Xe Sạch, kỹ
                thuật viên khuyến nghị bạn cần thực hiện:
              </Text>
              ...
              <View style={getStyles(theme).recommendationList}>
                <View style={getStyles(theme).recommendationItem}>
                  <View
                    style={[
                      getStyles(theme).benefitCheckWrapper,
                      { backgroundColor: theme.colors.success + '1A' },
                    ]}
                  >
                    <Check color="#10B981" size={10} strokeWidth={3} />
                  </View>
                  <Text style={[getStyles(theme).recommendationText, { color: colors.text }]}>
                    Thay nhớt máy & Nhớt hộp số (nhớt lốp).
                  </Text>
                </View>
                ...
                <View style={getStyles(theme).recommendationItem}>
                  ...
                  <Text style={[getStyles(theme).recommendationText, { color: colors.text }]}>
                    Kiểm tra hệ thống phanh an toàn trước & sau.
                  </Text>
                </View>
              </View>
            </View>
        ...
        <View style={getStyles(theme).alertActionContainer}>
          ...
          <TouchableOpacity style={styles.alertSecondaryBtn} onPress={() => navigation.goBack()}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={[getStyles(theme).voucherHeader, { borderBottomColor: colors.border }]}>
            <View
              style={[
                getStyles(theme).voucherIconCircle,
            ...
            <Text
              style={[
                getStyles(theme).detailTitle,
                { color: colors.text, textAlign: 'center', marginTop: 15 },
              ]}
            >
              {activeItem.title}
            </Text>
            <Text style={[getStyles(theme).voucherSubtitle, { color: colors.subtext }]}>
              Mã ưu đãi độc quyền dành cho bạn
            </Text>
          </View>
          ...
          <View style={styles.voucherBody}>
            ...
            <View
              style={[
                getStyles(theme).voucherInfoBoard,
                {
                  borderColor: colors.border,
            ...
            >
              ...
              <View style={getStyles(theme).infoBoardRow}>
                <View
                  style={[getStyles(theme).infoIconBg, { backgroundColor: 'rgba(59,130,246,0.1)' }]}
                >
                  <Calendar color="#E31B23" size={16} />
                </View>
                <View style={getStyles(theme).infoBoardCol}>
                  <Text style={[getStyles(theme).infoLabel, { color: colors.subtext }]}>
                    Thời gian áp dụng
                  </Text>
                  <Text style={[getStyles(theme).infoVal, { color: colors.text }]}>
                    Từ 15/05/2026 đến hết 31/12/2026
                  </Text>
                </View>
              </View>
              ...
              <View
                style={[
                  getStyles(theme).infoBoardRow,
                  { borderTopWidth: 1, borderTopColor: colors.border },
                ]}
              >
                <View
                  style={[getStyles(theme).infoIconBg, { backgroundColor: 'rgba(16,185,129,0.1)' }]}
                >
                ...
                <View style={getStyles(theme).infoBoardCol}>
                  ...
                  <Text style={[getStyles(theme).infoVal, { color: colors.text }]}>
                    {activeItem.title.includes('Nhớt')
                      ? 'Hội viên sở hữu Xe Côn Tay'
                      : 'Tất cả Khách hàng thành viên App'}
                  </Text>
                </View>
              </View>
              ...
              >
                <View
                  style={[getStyles(theme).infoIconBg, { backgroundColor: 'rgba(245,158,11,0.1)' }]}
                >
                ...
                <View style={getStyles(theme).infoBoardCol}>
                  ...
                  <Text style={[getStyles(theme).infoVal, { color: colors.text }]}>
                    Hệ thống Showroom & Xưởng sửa chữa AnhEmMotor Biên Hòa
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={getStyles(theme).benefitsSection}>
              <View style={getStyles(theme).benefitHeaderRow}>
                ...
                <Text
                  style={[
                    getStyles(theme).sectionHeading,
                    { color: colors.text, marginLeft: 8, marginBottom: 0 },
                  ]}
                >
                  Lợi ích của voucher khi sử dụng:
                </Text>
              </View>
              ...
              <View style={getStyles(theme).benefitList}>
                {benefits.map((benefit, idx) => (
                  <View key={idx} style={getStyles(theme).benefitItem}>
                    ...
                    <Text style={[getStyles(theme).benefitText, { color: colors.text }]}>
                      {benefit}
                    </Text>
                  </View>
                ))}
            ...
            <View style={getStyles(theme).couponDividerContainer}>
              <View
                style={[
                  getStyles(theme).couponDividerLeftCircle,
                  { backgroundColor: colors.background, borderColor: colors.border },
                ]}
              />
              <View
                style={[getStyles(theme).couponDividerDashLine, { borderColor: colors.border }]}
              />
              <View
                style={[
                  getStyles(theme).couponDividerRightCircle,
                  { backgroundColor: colors.background, borderColor: colors.border },
                ]}
              />
            </View>
            ...
            <View style={getStyles(theme).qrSection}>
              ...
              >
                Mã QR thanh toán tại quầy
              </Text>
              <View style={[getStyles(theme).qrContainer, { backgroundColor: '#FFFFFF' }]}>
                <QrCode color="#000" size={moderateScale(160)} />
              </View>
              <Text
                style={{ color: colors.subtext, fontSize: 11, marginTop: 10, textAlign: 'center' }}
              >
                Đưa mã này cho lễ tân của showroom AnhEmMotor trước khi thanh toán.
              </Text>
            </View>
            ...
            {!!activeItem.code && (
              ...
              >
                <Text style={[getStyles(theme).codeLabel, { color: colors.subtext }]}>
                  MÃ VOUCHER ĐỂ SAO CHÉP
                </Text>
                <View style={getStyles(theme).codeRow}>
                  <Text style={[getStyles(theme).codeVal, { color: colors.primary }]}>
                    {activeItem.code}
                  </Text>
                  <TouchableOpacity onPress={copyToClipboard} style={getStyles(theme).copyBtn}>
                    {copied ? (
                      ...
                      <Copy color={colors.subtext} size={18} />
                    )}
                  </TouchableOpacity>
                </View>
              </View>
            ...
            <View style={[getStyles(theme).rulesSection, { borderTopColor: colors.border }]}>
              <Text style={[getStyles(theme).sectionHeading, { color: colors.text, fontSize: 13 }]}>
                Điều khoản bổ sung:
              </Text>
              <Text style={[getStyles(theme).ruleItem, { color: colors.subtext }]}>
                • Vui lòng xuất trình mã ưu đãi trước khi lập hóa đơn thanh toán.
              </Text>
              <Text style={[getStyles(theme).ruleItem, { color: colors.subtext }]}>
                • Voucher không có giá trị quy đổi thành tiền mặt hoặc thặng dư khác.
              </Text>
              <Text style={[getStyles(theme).ruleItem, { color: colors.subtext }]}>
                • Không áp dụng đồng thời với các chương trình khuyến mãi nội bộ khác.
              </Text>
            </View>
          </View>
        </GlassCard>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 50 }}>
        ...
        {!!activeItem.image && (
          <View style={getStyles(theme).heroContainer}>
            ...
            <TouchableOpacity
              style={[getStyles(theme).floatingBadge, { backgroundColor: theme.colors.primary }]}
            >
              <Text style={getStyles(theme).floatingBadgeText}>
                {activeItem.category || 'ƯU ĐÃI'}
              </Text>
            </TouchableOpacity>
          </View>
        )}
        <View style={styles.detailsBody}>
          <Text
            style={[
              styles.detailTitle,
              { color: colors.text, fontSize: 22, lineHeight: 28, marginBottom: 15 },
            ]}
          >
            {activeItem.title}
          </Text>
          ...
          <GlassCard
            style={[
              getStyles(theme).countdownCard,
              { borderColor: theme.colors.secondary + '33', backgroundColor: theme.colors.card },
            ]}
            intensity={15}
          >
            <View style={getStyles(theme).countdownTitleRow}>
              ...
              <Text
                style={[getStyles(theme).countdownHeadingText, { color: theme.colors.secondary }]}
              >
                Hết hạn trong:
              </Text>
            </View>
            <View style={getStyles(theme).timerRow}>
              <View
                style={[
                  getStyles(theme).timeBox,
                  {
                    backgroundColor: isDark
                      ? theme.colors.border + '33'
                      : theme.colors.border + '1A',
                  },
                ]}
              >
                <Text style={[getStyles(theme).timeText, { color: colors.text }]}>
                  {countdown.days}
                </Text>
              ...
              >
                <Text style={[getStyles(theme).timeText, { color: theme.colors.secondary }]}>
          ...
          <View style={styles.limitContainer}>
            ...
            >
              <View
                style={[styles.progressBarFill, { width: '86%', backgroundColor: colors.primary }]}
              />
            </View>
            <Text style={{ color: colors.subtext, fontSize: 11, marginTop: 5 }}>
              Ưu đãi áp dụng giới hạn, vui lòng đăng ký sớm!
            </Text>
          </View>
          ...
          <GlassCard style={styles.promoDescCard}>
            <Text style={[styles.bodyText, { color: colors.text, fontSize: 15, lineHeight: 24 }]}>
              Chương trình khuyến mãi đặc biệt dành riêng cho các hội viên của AnhEmMotor. Cơ hội
              nâng cấp, bảo trì xe máy của bạn với mức phí ưu đãi cực tốt cùng quà tặng đi kèm có
              giá trị.
            </Text>
            <Text
              style={[
                styles.bodyText,
                { color: colors.text, fontSize: 15, lineHeight: 24, marginTop: 15 },
              ]}
            >
              • Giảm ngay giá trị trực tiếp trên hóa đơn sửa chữa.{'\n'}• Tặng kèm gói phủ bóng Nano
              bảo vệ bề mặt sơn chống xước dăm.{'\n'}• Rửa xe bọt tuyết làm sạch toàn diện miễn phí
              sau khi hoàn thành.
            </Text>
          </GlassCard>
          ...
          <Text
            style={[
              getStyles(theme).sectionTitleDetail,
              { color: colors.text, marginTop: 25, marginBottom: 15 },
            ]}
          >
          ...
          <View style={getStyles(theme).stepsContainer}>
            <View style={getStyles(theme).stepItem}>
              <View
                style={[getStyles(theme).stepIconCircle, { backgroundColor: theme.colors.primary }]}
              >
                <Gift color="#fff" size={16} />
              </View>
              <View style={getStyles(theme).stepTextContent}>
                <Text style={[getStyles(theme).stepTitleText, { color: colors.text }]}>
                  Bước 1: Nhận mã ưu đãi
                </Text>
                <Text style={[getStyles(theme).stepDescText, { color: colors.subtext }]}>
                  Nhấp vào nút "Nhận ưu đãi ngay" ở chân màn hình.
                </Text>
              </View>
            </View>
            <View
              style={[getStyles(theme).stepConnectorLine, { backgroundColor: colors.border }]}
            />
            ...
            <View style={getStyles(theme).stepItem}>
              ...
              <View style={getStyles(theme).stepTextContent}>
                <Text style={[getStyles(theme).stepTitleText, { color: colors.text }]}>
                  Bước 2: Đặt lịch hẹn sửa chữa
                </Text>
                <Text style={[getStyles(theme).stepDescText, { color: colors.subtext }]}>
                  Đặt lịch làm dịch vụ trước để tránh phải xếp hàng lâu.
                </Text>
              </View>
            </View>
            <View
            ...
            <View style={styles.stepItem}>
              ...
              <View style={styles.stepTextContent}>
                <Text style={[styles.stepTitleText, { color: colors.text }]}>
                  Bước 3: Ghé Showroom làm dịch vụ
                </Text>
                <Text style={[styles.stepDescText, { color: colors.subtext }]}>
                  Đưa mã ưu đãi cho lễ tân trước khi thanh toán.
                </Text>
              </View>
            </View>
          </View>
          ...
          <ScalePress
            ...
            onPress={() => {
              ...
              alert(
                'Đăng ký ưu đãi thành công! Mã ưu đãi AEM_PROMO_50K đã được sao chép vào bộ nhớ đệm.'
              );
            }}
          >
  ...
  const renderNewsDetail = () => {
    return (
      <View style={{ flex: 1 }}>
        ...
        <View
          style={[
            getStyles(theme).progressIndicatorBg,
            { backgroundColor: isDark ? 'rgba(255,255,255,0.05)' : '#E2E8F0' },
          ]}
        >
          <View
            style={[
              getStyles(theme).progressIndicatorFill,
        ...
        >
          ...
          <View style={styles.detailsBody}>
            <View style={getStyles(theme).newsMeta}>
              <View
                style={[
                  getStyles(theme).newsBadge,
                  { backgroundColor: theme.colors.primary + '1A' },
                ]}
              >
                <Text style={[getStyles(theme).newsBadgeText, { color: theme.colors.primary }]}>
                  TIN TỨC XE
                </Text>
              </View>
              <Text style={[getStyles(theme).newsDate, { color: colors.subtext }]}>
                {activeItem.date || '17/05/2026'}
              </Text>
            </View>
            ...
            <Text
              style={[
                getStyles(theme).detailTitle,
                { color: colors.text, fontSize: 22, lineHeight: 30, marginBottom: 15 },
              ]}
            >
              {activeItem.title}
            </Text>
            ...
            <View
              style={[
                getStyles(theme).authorCard,
                { borderBottomColor: colors.border, borderTopColor: colors.border },
              ]}
            >
              <View
                style={[
                  getStyles(theme).authorAvatar,
                  { backgroundColor: theme.colors.border + '1A' },
                ]}
              >
              ...
              <View>
                <Text style={[styles.authorName, { color: colors.text }]}>
                  {activeItem.author || 'AnhEmMotor Editor'}
                </Text>
                <Text style={{ color: colors.subtext, fontSize: 11 }}>
                  Biên tập viên đời sống xe • 5 phút đọc
                </Text>
              </View>
            </View>
            ...
            <GlassCard
              style={[
                getStyles(theme).aiSummaryCard,
                { borderColor: theme.colors.info + '33', backgroundColor: theme.colors.card },
              ]}
              intensity={15}
            >
              <View style={getStyles(theme).aiSummaryHeader}>
                <Sparkles color="#A855F7" size={18} />
                <Text style={[getStyles(theme).aiSummaryTitle, { color: theme.colors.info }]}>
                  Tóm tắt nhanh bằng AI:
                </Text>
              </View>
              <View style={styles.aiSummaryBullets}>
                <Text style={[styles.aiBulletText, { color: colors.text }]}>
                  💡 Bảo dưỡng định kỳ giúp tăng tuổi thọ động cơ thêm 35% và tiết kiệm 12% xăng
                  tiêu thụ.
                </Text>
                <Text style={[styles.aiBulletText, { color: colors.text }]}>
                  💡 Ba hạng mục bắt buộc kiểm tra mỗi 5.000 km bao gồm: dầu nhớt, bộ lọc gió động
                  cơ, bugi đánh lửa.
                </Text>
                <Text style={[styles.aiBulletText, { color: colors.text }]}>
                  💡 Lốp xe cần kiểm tra áp suất định kỳ mỗi tuần để ngăn ngừa nguy cơ mòn vẹt và nổ
                  lốp đột ngột.
                </Text>
              </View>
            </GlassCard>
            ...
            {newsContent ? (
              ...
              <View>
                <Text
                  style={[
                    styles.bodyText,
                    { color: colors.text, fontSize: 15, lineHeight: 26, marginTop: 20 },
                  ]}
                >
                  {activeItem.desc ||
                    'Đời sống xe và tin tức nóng hổi luôn được cập nhật liên tục hàng giờ. AnhEmMotor cam kết mang lại cho khách hàng những thông tin bổ ích nhất về bảo dưỡng xe, kỹ năng lái xe an toàn, luật giao thông đường bộ mới nhất.'}
                </Text>

                <Text
                  style={[
                    styles.bodyText,
                    { color: colors.text, fontSize: 15, lineHeight: 26, marginTop: 15 },
                  ]}
                >
                  Theo nghiên cứu mới nhất của Hiệp hội Motor Việt Nam, việc bảo dưỡng xe định kỳ
                  giúp tăng tuổi thọ động cơ lên đến 35%, đồng thời giảm mức tiêu hao nhiên liệu
                  khoảng 12% so với thông thường. Đây là lý do vì sao người sử dụng xe máy nên chú
                  trọng mốc km thay dầu và vệ sinh lọc gió định kỳ để có trải nghiệm lái êm ái nhất.
                </Text>
                ...
                >
                  "Chiếc xe chính là người bạn đường trung thành. Chăm chút kỹ càng cho khối động cơ
                  sẽ mang lại sự an tâm tuyệt đối trên mọi nẻo đường hành trình của bạn."
                </Text>
              </View>
            )}
            ...
            <View
              style={[
                getStyles(theme).reactionContainer,
                { borderTopColor: colors.border, borderBottomColor: colors.border },
              ]}
            >
              <Text style={[getStyles(theme).reactionHeading, { color: colors.text }]}>
              ...
              <View style={getStyles(theme).reactionRow}>
                <TouchableOpacity
                  style={[
                    styles.reactionChip,
                    {
                      backgroundColor: userReactions.likes
                ...
                >
                  <ThumbsUp
                    color={userReactions.likes ? theme.colors.primary : colors.subtext}
                    size={15}
                  />
                  <Text
                    style={[
                      getStyles(theme).reactionCountText,
                      { color: userReactions.likes ? theme.colors.primary : colors.text },
                    ]}
                  >
                    {reactions.likes}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.reactionChip,
                    {
                      backgroundColor: userReactions.hearts
                        ? 'rgba(239,68,68,0.15)'
                        : isDark
                          ? 'rgba(255,255,255,0.05)'
                          : '#F1F5F9',
                ...
                >
                  <Heart
                    color={userReactions.hearts ? theme.colors.secondary : colors.subtext}
                    size={15}
                  />
                  <Text
                    style={[
                      getStyles(theme).reactionCountText,
                      { color: userReactions.hearts ? theme.colors.secondary : colors.text },
                    ]}
                  >
                    {reactions.hearts}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.reactionChip,
                    {
                      backgroundColor: userReactions.bikes
                ...
                >
                  <Bike
                    color={userReactions.bikes ? theme.colors.success : colors.subtext}
                    size={15}
                  />
                  <Text
                    style={[
                      getStyles(theme).reactionCountText,
                      { color: userReactions.bikes ? theme.colors.success : colors.text },
                    ]}
                  >
                    {reactions.bikes}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.reactionChip,
                    {
                      backgroundColor: userReactions.helpful
                ...
                >
                  <Sparkles
                    color={userReactions.helpful ? theme.colors.info : colors.subtext}
                    size={15}
                  />
                  <Text
                    style={[
                      getStyles(theme).reactionCountText,
                      { color: userReactions.helpful ? theme.colors.info : colors.text },
                    ]}
                  >
                    {reactions.helpful}
                  </Text>
            ...
            <View style={getStyles(theme).commentSection}>
              ...
              <View
                style={[
                  getStyles(theme).commentInputBox,
                  {
                    backgroundColor: isDark
                      ? theme.colors.border + '33'
                      : theme.colors.border + '1A',
              ...
              >
                <TextInput
                  style={[getStyles(theme).commentTextInput, { color: colors.text }]}
              ...
              {comments.map((comment) => (
                ...
                >
                  ...
                  <View style={styles.commentTextCol}>
                    ...
                    <Text style={[styles.commentBodyText, { color: colors.text }]}>
                      {comment.text}
                    </Text>
                  </View>
                </View>
                ...
                {MOCK_RELATED_NEWS.map((item) => (
                  ...
                  >
                    ...
                    <View style={styles.relatedCardInfo}>
                      <Text
                        style={[styles.relatedCardTitle, { color: colors.text }]}
                        numberOfLines={2}
                      >
                        {item.title}
                      </Text>
    ...
    >
      ...
      >
        ...
        <View style={getStyles(theme).modalOverlay}>
          <TouchableOpacity
            style={getStyles(theme).modalBackdrop}
            activeOpacity={1}
          ...
          >
            <View
              style={[
                getStyles(theme).modalHandle,
                { backgroundColor: isDark ? 'rgba(255,255,255,0.15)' : 'rgba(0,0,0,0.15)' },
              ]}
            />

            <View style={getStyles(theme).modalTitleRow}>
              <Text style={[getStyles(theme).modalTitle, { color: colors.text }]}>
                Đặt lịch bảo dưỡng 📅
              </Text>
              <TouchableOpacity
            ...
            <Text style={[styles.modalSub, { color: colors.subtext }]}>
              Honda SH 160i (60-A1 555.55)
            </Text>

            {}
            <Text style={[styles.bookingSectionTitle, { color: colors.text, marginTop: 5 }]}>
              1. Chọn ngày đến xưởng:
            </Text>
            <View style={getStyles(theme).bookingDateRow}>
              {[
                ...
                >
                  <Text
                    style={[
                      styles.bookingDateDayLabel,
                      { color: selectedDate === item.date ? '#fff' : colors.subtext },
                    ]}
                  >
                    {item.label}
                  </Text>
                  <Text
                    style={[
                      styles.bookingDateDayNumber,
                      { color: selectedDate === item.date ? '#fff' : colors.text },
                    ]}
                  >
                    {item.day}
                  </Text>
            ...
            {}
            <Text style={[getStyles(theme).bookingSectionTitle, { color: colors.text }]}>
              2. Chọn khung giờ:
            </Text>
            <View style={getStyles(theme).bookingTimeGrid}>
              {['08:00', '09:30', '11:00', '14:00', '15:30', '17:00'].map((time) => (
                ...
                >
                  <Clock
                    size={12}
                    color={selectedTime === time ? '#fff' : colors.subtext}
                    style={{ marginRight: 6 }}
                  />
                  <Text
                    style={[
            ...
            <TouchableOpacity
              style={[
                getStyles(theme).modalActionBtn,
