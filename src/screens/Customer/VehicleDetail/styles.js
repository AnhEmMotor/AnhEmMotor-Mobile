...
export const styles = StyleSheet.create({
  ...
  activeColorCircle: { borderColor: Theme.colors.primary },
  ...
  rewardHighlight: { color: Theme.colors.primary, fontWeight: 'bold' },
  ...
  tabText: { color: Theme.colors.subtext, fontWeight: 'bold', fontSize: 13, letterSpacing: 0.5 },
  ...
  featureCard: { width: '48%', backgroundColor: Theme.colors.card, padding: moderateScale(15), borderRadius: Theme.radius.md, marginBottom: verticalScale(12), borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  featureIcon: { marginBottom: 10 },
  featureTitle: { color: '#fff', fontSize: moderateScale(14), fontWeight: 'bold', marginBottom: 4 },
  featureDesc: { color: Theme.colors.subtext, fontSize: moderateScale(11), lineHeight: 16 },
  ...
  teaserDesc: { color: Theme.colors.subtext, fontSize: moderateScale(13), marginBottom: 12 },
  teaserLink: { color: Theme.colors.primary, fontWeight: 'bold', fontSize: moderateScale(13) },

  // Specs Tab
  specGroup: { marginBottom: verticalScale(25) },
  specGroupTitle: { color: Theme.colors.primary, fontSize: moderateScale(15), fontWeight: 'bold', marginBottom: verticalScale(8) },
  ...
  specLabel: { color: Theme.colors.subtext, fontSize: moderateScale(14) },
  ...
  calcLabel: { color: Theme.colors.subtext, fontSize: moderateScale(14), marginBottom: 15 },
  ...
  checklist: { backgroundColor: 'rgba(255,255,255,0.02)', padding: 15, borderRadius: 12, borderLeftWidth: 3, borderLeftColor: Theme.colors.primary },
  checkItem: { color: Theme.colors.subtext, fontSize: 13, marginBottom: 8 },
  ...
  reviewContent: { color: Theme.colors.subtext, fontSize: 14, lineHeight: 20, marginBottom: 10 },
  showroomReply: { backgroundColor: 'rgba(0,0,0,0.2)', padding: 12, borderRadius: 8, marginTop: 5 },
  replyTitle: { color: Theme.colors.primary, fontSize: 12, fontWeight: 'bold', marginBottom: 4 },
  replyContent: { color: Theme.colors.subtext, fontSize: 12, fontStyle: 'italic' },
  ...
  stickyActions: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', padding: 20, backgroundColor: Theme.colors.background, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.05)' },
