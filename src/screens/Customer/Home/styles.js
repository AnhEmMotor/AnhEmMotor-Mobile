...
export const styles = StyleSheet.create({
  ...
  greeting: { color: Theme.colors.subtext, fontSize: moderateScale(14) },
  userName: { color: Theme.colors.text, fontSize: moderateScale(22), fontWeight: 'bold' },
  headerRight: { flexDirection: 'row', alignItems: 'center' },
  iconBtn: { width: horizontalScale(44), height: horizontalScale(44), borderRadius: horizontalScale(22), backgroundColor: Theme.colors.card, justifyContent: 'center', alignItems: 'center', marginLeft: horizontalScale(10) },
  avatar: { width: horizontalScale(44), height: horizontalScale(44), borderRadius: horizontalScale(22), borderWidth: 1, borderColor: Theme.colors.primary },
  badge: { position: 'absolute', top: 0, right: 0, backgroundColor: Theme.colors.error, minWidth: moderateScale(18), height: moderateScale(18), borderRadius: moderateScale(9), justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: Theme.colors.card },
  ...
  shortcutText: { color: Theme.colors.text, fontSize: moderateScale(11), fontWeight: '600' },

  deliveryCard: { padding: moderateScale(24), borderRadius: Theme.radius.lg, overflow: 'hidden' },
  deliveryTitle: { color: Theme.colors.subtext, fontSize: moderateScale(14), marginBottom: verticalScale(4) },
  deliveryVehicle: { color: Theme.colors.text, fontSize: moderateScale(18), fontWeight: 'bold', marginBottom: verticalScale(20) },
  ...
  progressStep: { color: Theme.colors.text, fontSize: moderateScale(13), flex: 1 },
  progressEstimate: { color: Theme.colors.success, fontSize: moderateScale(13), fontWeight: 'bold' },
  
  alertModule: { marginBottom: verticalScale(30) },
  sectionTitle: { color: Theme.colors.text, fontSize: moderateScale(18), fontWeight: 'bold', marginBottom: verticalScale(15) },
  ...
  alertTitle: { color: Theme.colors.text, fontSize: moderateScale(14), fontWeight: 'bold', marginBottom: verticalScale(2) },
  alertDesc: { color: Theme.colors.subtext, fontSize: moderateScale(12), lineHeight: moderateScale(16), marginBottom: verticalScale(8) },
  ...
  voucherDesc: { color: Theme.colors.subtext, fontSize: moderateScale(12), lineHeight: moderateScale(16) },
  ...
  viewAll: { color: Theme.colors.primary, fontSize: moderateScale(13), fontWeight: '600' },
  ...
  exploreCat: { color: Theme.colors.primary, fontSize: moderateScale(10), fontWeight: 'bold', marginBottom: verticalScale(2) },
  ...
  blogInfo: { flex: 1 },
  blogTitle: { color: Theme.colors.text, fontSize: moderateScale(15), fontWeight: 'bold', marginBottom: verticalScale(4) },
  blogDesc: { color: Theme.colors.subtext, fontSize: moderateScale(12), lineHeight: moderateScale(16), marginBottom: verticalScale(6) },
  blogMeta: { color: Theme.colors.primary, fontSize: moderateScale(10), fontWeight: '600' },
  ...
  bsTitle: { color: Theme.colors.text, fontSize: moderateScale(20), fontWeight: 'bold', marginBottom: verticalScale(8), textAlign: 'center' },
  bsDesc: { color: Theme.colors.subtext, fontSize: moderateScale(14), textAlign: 'center', marginBottom: verticalScale(30), paddingHorizontal: horizontalScale(20) },
  ...
  bsCodeLabel: { color: Theme.colors.subtext, fontSize: moderateScale(12), marginBottom: verticalScale(4), letterSpacing: 1 },
  bsCodeValue: { color: Theme.colors.primary, fontSize: moderateScale(24), fontWeight: '900', letterSpacing: 2 }
});
