        ...
        >
          <Text
            style={[
              ...
              activeTab === 'purchases' && { color: activeColors.primary },
            ]}
          >
            Sở hữu xe
          </Text>
        ...
        >
          <Text
            style={[
              styles.tabText,
              { color: activeColors.subtext },
              activeTab === 'services' && { color: activeColors.primary },
            ]}
          >
            Dịch vụ & Linh kiện
          </Text>
          ...
          <Animated.View key={item.id} entering={FadeInDown.duration(600).delay(index * 100)}>
            <GlassCard style={styles.card}>
              ...
              <View style={styles.cardFooter}>
                <View>
                  <Text style={[styles.totalLabel, { color: activeColors.subtext }]}>
                    Tổng chi phí
                  </Text>
                  <Text style={[styles.totalValue, { color: activeColors.text }]}>
                    {item.total}
                  </Text>
                </View>
          ...
          >
            ...
            <View style={styles.breakdown}>
              ...
              <View style={styles.totalRow}>
                <Text style={[styles.totalFinalLabel, { color: activeColors.text }]}>
                  TỔNG CỘNG
                </Text>
                <Text style={[styles.totalFinalVal, { color: activeColors.primary }]}>
