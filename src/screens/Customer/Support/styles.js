...
export const styles = StyleSheet.create({
  ...
  title: { color: Theme.colors.text, fontSize: moderateScale(26), fontWeight: 'bold' },
  ...
  primaryBtn: { flex: 1, height: verticalScale(48), borderRadius: Theme.radius.md, backgroundColor: Theme.colors.primary, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight: horizontalScale(12) },
  ...
  secondaryBtnText: { color: Theme.colors.text, fontSize: moderateScale(13), fontWeight: '600', marginLeft: horizontalScale(8) },
  
  sectionLabel: { color: Theme.colors.text, fontSize: moderateScale(18), fontWeight: 'bold', marginTop: verticalScale(10), marginBottom: verticalScale(15) },
  
  // Form Phản hồi - Tầng 2
  formCard: { padding: moderateScale(18), borderRadius: Theme.radius.lg, marginBottom: verticalScale(25) },
  dropdownLabel: { color: Theme.colors.subtext, fontSize: moderateScale(12), marginBottom: verticalScale(6) },
  ...
  submitBtn: { flex: 1, height: verticalScale(48), borderRadius: Theme.radius.md, backgroundColor: Theme.colors.primary, justifyContent: 'center', alignItems: 'center', marginLeft: horizontalScale(12) },
  ...
  ticketType: { color: Theme.colors.primary, fontSize: moderateScale(12), fontWeight: 'bold' },
  ticketStatus: { fontSize: moderateScale(11), fontWeight: '600' },
  ticketContent: { color: Theme.colors.text, fontSize: moderateScale(13), lineHeight: 18, marginBottom: verticalScale(8) },
  ticketFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ticketDate: { color: Theme.colors.subtext, fontSize: moderateScale(11) },
  ...
  faqCatTitle: { color: Theme.colors.text, fontSize: moderateScale(14), fontWeight: 'bold', marginLeft: horizontalScale(8) },
  ...
  faqQuestion: { color: Theme.colors.text, fontSize: moderateScale(13), fontWeight: '600', flex: 1, paddingRight: horizontalScale(10) },
  ...
  systemHours: { color: Theme.colors.subtext, fontSize: moderateScale(12), marginBottom: verticalScale(15) },
  ...
  sheetOptionText: { color: Theme.colors.text, fontSize: moderateScale(14), fontWeight: '500' },
  sheetOptionSelectedText: { color: Theme.colors.primary, fontSize: moderateScale(14), fontWeight: 'bold' },
  ...
  chatBox: { backgroundColor: 'rgba(0,0,0,0.2)', borderRadius: Theme.radius.md, padding: moderateScale(14), borderLeftWidth: 3, borderLeftColor: Theme.colors.primary },
  chatAuthor: { color: Theme.colors.primary, fontSize: moderateScale(12), fontWeight: 'bold', marginBottom: verticalScale(4) },
  chatText: { color: 'rgba(255,255,255,0.85)', fontSize: moderateScale(13), lineHeight: 19 },
  
  // Sheet actions (Tầng 2 - Tương tác 2 chiều)
  sheetActionRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: verticalScale(20) },
  sheetCloseBtn: { flex: 1, height: verticalScale(44), borderRadius: Theme.radius.md, backgroundColor: Theme.colors.success, justifyContent: 'center', alignItems: 'center', marginRight: horizontalScale(10) },
  ...
  sheetDiscussBtnText: { color: Theme.colors.text, fontSize: moderateScale(13), fontWeight: '600' },

  // FAQ Details sheet (Tầng 3 - Quy tắc vàng 1)
  ...
  // Contact details before map (Tầng 4)
