...
export const styles = StyleSheet.create({
  ...
  colorInner: { width: 26, height: 26, borderRadius: 13 },
  colorCheck: {
    position: 'absolute',
    bottom: -2,
    right: -2,
  ...
  variantSection: { marginBottom: verticalScale(20) },
  variantLabel: { fontSize: moderateScale(13), fontWeight: '600', marginBottom: 10 },
  variantChip: {
  ...
  variantChipText: { fontSize: moderateScale(13), fontWeight: '600' },
  variantChipPrice: { fontSize: moderateScale(11), marginTop: 2 },
