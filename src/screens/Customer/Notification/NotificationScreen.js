  ...
  const renderActiveModalContent = () => {
    ...
    switch (logic.activeModal) {
      case 'deliveryMap':
        return (
          <View>
            <View style={[styles.mapContainer, { borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }]}>
              {/* Fake Map Grid */}
              ...
              <View style={styles.warehouseNode}>
                <View style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.1)', justifyContent: 'center', alignItems: 'center', marginBottom: 4 }}>
                  <Map color="#94A3B8" size={16} />
                </View>
                <Text style={styles.nodeLabel}>Kho Tổng</Text>
              </View>
              ...
              <View style={{ position: 'absolute', bottom: 12, left: 12, right: 12, backgroundColor: 'rgba(0,0,0,0.7)', padding: 8, borderRadius: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                <View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: '#10B981', marginRight: 6 }} />
                <Text style={{ color: '#fff', fontSize: moderateScale(10), fontWeight: 'bold' }}>GPS: Xe SH 160i cách Showroom 4.2 km</Text>
              </View>
            </View>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(12), lineHeight: 18, marginBottom: 20, textAlign: 'center' }}>
      ...
      case 'workshop':
        return (
          <View style={[styles.workshopCard, { borderWidth: 1, borderColor: 'rgba(16, 185, 129, 0.2)', backgroundColor: 'rgba(16, 185, 129, 0.02)' }]}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)', paddingBottom: 10 }}>
            ...
            <View style={[styles.techRow, { backgroundColor: 'rgba(255,255,255,0.02)', padding: 12, borderRadius: 12, marginBottom: 15 }]}>
              <View style={[styles.techAvatar, { backgroundColor: Theme.colors.primary }]}>
                <Text style={styles.techAvatarText}>H</Text>
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.techName}>KTV. Nguyễn Văn Hùng</Text>
                <Text style={styles.techTitle}>Kỹ thuật viên trưởng bàn số 3</Text>
              </View>
            ...
            <View style={{ gap: 8 }}>
              {[
                ...
                <View key={index} style={[styles.partItem, { backgroundColor: 'rgba(255,255,255,0.01)', borderBottomWidth: 0, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 8 }]}>
                  <Text style={[styles.partName, { color: '#fff', fontSize: moderateScale(11) }]}>{item.name}</Text>
      ...
      case 'referral':
        return (
          <View style={{ alignItems: 'center' }}>
            <View style={[styles.couponCard, { backgroundColor: '#1E1B4B', borderWidth: 1, borderColor: 'rgba(99, 102, 241, 0.25)', width: '100%', borderRadius: 16 }]}>
              <Text style={[styles.couponLabel, { color: '#818CF8' }]}>MÃ GIỚI THIỆU CỦA BẠN</Text>
              <Text style={[styles.couponCodeText, { color: '#fff', fontSize: moderateScale(22) }]}>{logic.selectedNotif.referralCode || 'AEM-KHOI-GOLD'}</Text>
              <Text style={[styles.couponDesc, { color: Theme.colors.subtext, fontSize: moderateScale(11), lineHeight: 16 }]}>
            ...
            <View style={{ flexDirection: 'row', width: '100%', marginBottom: 15, marginTop: 15 }}>
              <TouchableOpacity 
                style={{ flex: 1, height: 48, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.05)', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }}
                onPress={() => handleCopy(logic.selectedNotif.referralCode)}
              >
                <Copy color="#fff" size={14} />
                <Text style={{ color: '#fff', fontSize: moderateScale(12), fontWeight: 'bold', marginLeft: 8 }}>
      ...
      case 'voucher':
        return (
          <View style={{ alignItems: 'center', width: '100%' }}>
            ...
            <Text style={{ color: '#fff', fontSize: moderateScale(15), fontWeight: 'bold', textAlign: 'center', marginVertical: 12 }}>
              {logic.selectedNotif.voucherName}
            </Text>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(11), textAlign: 'center', lineHeight: 17, marginBottom: 20 }}>
      ...
      case 'invoice':
        return (
          <View>
            <View style={[styles.invoiceSheet, { backgroundColor: '#1C1917', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', borderRadius: 16, padding: 16, marginBottom: 15 }]}>
              <View style={[styles.invoiceHeader, { borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.08)', paddingBottom: 10, marginBottom: 12 }]}>
                <Text style={[styles.invoiceLogo, { color: Theme.colors.primary }]}>AnhEmMotor 🏍️</Text>
                <Text style={[styles.invoiceTitle, { color: Theme.colors.subtext, fontSize: moderateScale(10), fontWeight: 'bold' }]}>HÓA ĐƠN ĐIỆN TỬ (E-INVOICE)</Text>
              </View>
              
              <View style={{ gap: 8 }}>
                {[
                  { label: 'Mã hóa đơn', val: logic.selectedNotif.invoiceNumber || '#AEM-9982', color: '#fff' },
                  { label: 'Khách hàng', val: 'Nguyễn Văn Khôi', color: '#fff' },
                  { label: 'Sản phẩm', val: 'Honda SH 160i Thể thao', color: '#fff' },
                  { label: 'Nơi cấp hóa đơn', val: 'Tổng cục Thuế Việt Nam', color: '#fff' },
                  ...
                  <View key={idx} style={[styles.invoiceRow, { borderBottomWidth: 0, paddingVertical: 2, flexDirection: 'row', justifyContent: 'space-between' }]}>
                    <Text style={[styles.invoiceLabel, { color: Theme.colors.subtext, fontSize: moderateScale(11) }]}>{row.label}</Text>
                    <Text style={[styles.invoiceVal, { color: row.color, fontSize: moderateScale(11), fontWeight: 'bold' }]}>{row.val}</Text>
                  </View>
                ))}
              </View>
              
              <View style={[styles.invoiceTotalRow, { borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.08)', paddingTop: 10, marginTop: 12, flexDirection: 'row', justifyContent: 'space-between' }]}>
                <Text style={{ color: Theme.colors.subtext, fontWeight: 'bold', fontSize: moderateScale(11) }}>TỔNG CỘNG</Text>
            ...
            <TouchableOpacity 
              style={[styles.modalActionBtn, { backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', marginBottom: 15, height: 48, borderRadius: 12 }]}
              onPress={() => Alert.alert('Tải xuống', 'Hóa đơn đã được lưu dưới dạng PDF vào thư mục Downloads!')}
            >
              <Download color="#fff" size={14} />
              <Text style={{ color: '#fff', fontWeight: 'bold', marginLeft: 8, fontSize: moderateScale(12) }}>Tải về file PDF Hóa đơn</Text>
            </TouchableOpacity>
          </View>
        );
      ...
      case 'feedback':
        return (
          <View>
            <View style={[styles.letterPaper, { backgroundColor: '#1E1B4B', borderWidth: 1, borderColor: 'rgba(99, 102, 241, 0.2)', borderRadius: 16, padding: 16, marginBottom: 15 }]}>
              <View style={[styles.letterHeader, { borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)', paddingBottom: 8, marginBottom: 12 }]}>
                <Text style={[styles.letterLogo, { color: '#818CF8', fontSize: moderateScale(12), fontWeight: 'bold' }]}>ANHEMMOTOR BIÊN HÒA</Text>
                <Text style={[styles.letterDate, { color: Theme.colors.subtext, fontSize: moderateScale(10) }]}>Ngày 16 tháng 05 năm 2026</Text>
              </View>
              
              <Text style={[styles.letterBody, { color: '#fff', fontSize: moderateScale(12), fontStyle: 'italic', lineHeight: 20 }]}>
                "{logic.selectedNotif.feedbackContent}"
              </Text>
              
              <Text style={[styles.letterFooter, { color: '#818CF8', fontSize: moderateScale(11), fontWeight: 'bold', textAlign: 'right', marginTop: 15 }]}>Ban Điều Hành Showroom</Text>
            </View>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(11), textAlign: 'center', lineHeight: 16, marginBottom: 20 }}>
      ...
      case 'process':
        return (
          <View style={[styles.workshopCard, { borderWidth: 1, borderColor: 'rgba(59, 130, 246, 0.2)', backgroundColor: 'rgba(59, 130, 246, 0.02)' }]}>
            <View style={{ borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)', paddingBottom: 10, marginBottom: 12 }}>
            ...
            <View style={{ paddingVertical: 5, gap: 12 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(12), flex: 1 }}>Khai thuế trước bạ online (Đã hoàn thành)</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={{ color: '#fff', fontSize: moderateScale(12), fontWeight: 'bold', flex: 1 }}>Bấm biển số tại Biên Hòa (Đang tiến hành)</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ width: 20, height: 20, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.08)', justifyContent: 'center', alignItems: 'center', marginRight: 10 }}>
                  <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(10) }}>3</Text>
                </View>
                <Text style={{ color: 'rgba(255,255,255,0.3)', fontSize: moderateScale(12), flex: 1 }}>Lắp biển, rửa xe giao khách (Chờ xử lý)</Text>
              </View>
            </View>
          </View>
        );
      ...
      case 'cleancar':
        return (
          <View style={{ alignItems: 'center', paddingVertical: 15 }}>
            ...
            <Text style={{ color: '#fff', fontSize: moderateScale(16), fontWeight: 'bold', marginBottom: 10 }}>Chứng nhận Đạt chuẩn Xe Sạch</Text>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(12), textAlign: 'center', lineHeight: 18, marginBottom: 20 }}>
      ...
      case 'insurance':
        return (
          <View style={{ alignItems: 'center' }}>
            ...
            <Text style={{ color: '#fff', fontSize: moderateScale(15), fontWeight: 'bold', marginBottom: 10 }}>Gia hạn bảo hiểm xe máy trực tuyến</Text>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(12), textAlign: 'center', lineHeight: 18, marginBottom: 20 }}>
      ...
      case 'security':
        return (
          <View style={{ alignItems: 'center' }}>
            ...
            <Text style={{ color: '#fff', fontSize: moderateScale(15), fontWeight: 'bold', marginBottom: 10 }}>Nâng cấp bảo mật tài khoản</Text>
            <Text style={{ color: Theme.colors.subtext, fontSize: moderateScale(12), textAlign: 'center', lineHeight: 18, marginBottom: 20 }}>
      ...
      default:
        return (
          <View>
            <Text style={{ color: '#fff', fontSize: moderateScale(13), lineHeight: 18, marginBottom: 25, textAlign: 'center' }}>
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: activeColors.background }]} edges={['top']}>
      ...
      <Animated.View entering={FadeInUp.duration(600).delay(100)} style={styles.header}>
        ...
        <TouchableOpacity onPress={logic.markAllAsRead}>
        ...
        {logic.activeTab === 'service' ? (
          <View>
            ...
            <View style={styles.demoToggleContainer}>
              <Text style={styles.demoToggleText}>Mô phỏng xe tại xưởng Biên Hòa:</Text>
              <TouchableOpacity 
                style={[styles.demoToggleButton, logic.hasActiveWorkshop ? styles.demoToggleButtonActive : styles.demoToggleButtonInactive]}
                onPress={() => logic.setHasActiveWorkshop(!logic.hasActiveWorkshop)}
              >
                <Text style={styles.demoToggleButtonLabel}>
            ...
            {logic.hasActiveWorkshop && (
              <Animated.View entering={FadeInDown.duration(500)} style={styles.workshopLiveCard}>
                ...
                <Text style={styles.vehicleInfoText}>Xe Honda SH 160i (Biển số: 60-A1 555.55)</Text>

                {/* KTV Info */}
                <View style={styles.ktvRow}>
                  <View style={styles.ktvAvatar}>
                    <Text style={styles.ktvAvatarText}>H</Text>
                  </View>
                  <View style={{ flex: 1 }}>
                    <Text style={styles.ktvName}>KTV. Nguyễn Văn Hùng</Text>
                    <Text style={styles.ktvSub}>Kỹ thuật viên trưởng bàn số 3 (Tay nghề 8 năm)</Text>
                  </View>
                </View>
                      ...
                      <View key={item.step} style={styles.stepItem}>
                        ...
                        <View style={[
                          ...
                          {isCompleted ? (
                            ...
                            <Text style={styles.pendingStepText}>{item.step}</Text>
                          )}
                        </View>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(100)} style={styles.alertCard}>
              ...
              <View style={styles.odoContainer}>
                ...
                <View style={styles.odoLabels}>
                  <Text style={styles.odoLabelText}>Lần bảo dưỡng trước</Text>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(200)} style={styles.historySection}>
              ...
              <Text style={styles.historySubtitle}>Cuốn sổ bảo hành điện tử thay thế hoàn toàn sổ giấy, lưu trọn đời tại AnhEmMotor</Text>
              ...
              {logic.serviceHistory.map((item) => (
                <View key={item.id} style={styles.historyItemCard}>
                  ...
                  <Text style={styles.historyPartsTitle}>Phụ tùng đã thay & Dịch vụ:</Text>
                  <Text style={styles.historyPartsText}>{item.parts}</Text>

                  <View style={styles.historyFooter}>
                    <Text style={styles.historyCost}>Hóa đơn: <Text style={{fontWeight: 'bold', color: '#10B981'}}>{item.cost}</Text></Text>
                    <Text style={styles.historyWarranty}>BH phụ tùng: {item.warranty}</Text>
                  </View>
                </View>
              ))}
            </Animated.View>
          ...
          <View>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(100)} style={styles.loyaltyVoucherCard}>
              ...
              <View style={styles.dashedVoucherBody}>
                <View style={styles.dashedVoucherLeft}>
                  <Text style={styles.voucherValBig}>2M</Text>
                  <Text style={styles.voucherValLabel}>ĐỒNG</Text>
                </View>
                <View style={styles.dashedVoucherRight}>
                  <Text style={styles.voucherNameTitle}>Voucher đổi xe SH</Text>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(200)} style={styles.loyaltyBirthdayCard}>
              ...
              <View style={styles.birthdayGiftBox}>
                <Text style={styles.birthdayGiftTitle}>Miễn phí thay nhớt máy tháng sinh nhật 🎂</Text>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(300)} style={styles.loyaltyReferralCard}>
              ...
              <View style={styles.referralCodeDashCard}>
                <Text style={styles.referralCodeTextVal}>AEM-KHOI-GOLD</Text>
                <Text style={styles.referralCodeSubText}>Nhận 500.000đ dịch vụ khi bạn bè mua xe thành công</Text>
              </View>
          ...
          <View>
            ...
            <Animated.View entering={FadeInDown.duration(500)} style={styles.systemRecallCard}>
              ...
              <Text style={styles.systemRecallDesc}>
                Thông báo từ <Text style={{fontWeight: 'bold', color: '#fff'}}>Honda Việt Nam</Text>: Triệu hồi và cập nhật miễn phí cụm khóa Smartkey cho các dòng xe SH sản xuất trong giai đoạn đầu năm 2025 để nâng cấp bảo mật. Hãy đặt lịch hẹn sớm nhất tại đại lý gần nhất.
              </Text>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(100)} style={styles.systemInsuranceCard}>
              ...
              <Text style={styles.systemInsuranceDesc}>
                Bảo hiểm dân sự bắt buộc của xe <Text style={{fontWeight: 'bold', color: '#fff'}}>60-A1 555.55</Text> sẽ hết hạn vào ngày <Text style={{fontWeight: 'bold', color: Theme.colors.warning}}>20/05/2026</Text>. Hãy gia hạn trực tuyến để tránh bị phạt khi lưu thông trên đường.
              </Text>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(200)} style={styles.systemInvoiceCard}>
              ...
              <View style={styles.invoiceSummaryBox}>
                <View style={styles.invoiceSummaryRow}>
                  ...
                  <Text style={styles.invoiceSummaryVal}>#AEM-9982</Text>
                </View>
                <View style={styles.invoiceSummaryRow}>
          ...
          <View>
            ...
            <Animated.View entering={FadeInDown.duration(500)} style={styles.systemFeedbackCard}>
              ...
              <View style={styles.feedbackParchmentPaper}>
                <Text style={styles.feedbackParchmentBody}>
            ...
            <Animated.View entering={FadeInDown.duration(500).delay(100)} style={[styles.systemFeedbackCard, { borderColor: 'rgba(16, 185, 129, 0.15)', backgroundColor: 'rgba(16, 185, 129, 0.03)' }]}>
              ...
              <View style={[styles.feedbackParchmentPaper, { backgroundColor: 'rgba(16, 185, 129, 0.02)', borderColor: 'rgba(16, 185, 129, 0.1)' }]}>
                <Text style={[styles.feedbackParchmentBody, { color: 'rgba(255,255,255,0.7)', fontStyle: 'italic' }]}>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          <Animated.View entering={FadeInDown.duration(400)} style={styles.modalSheet}>
            ...
            <Text style={styles.modalSub}>{logic.selectedNotif?.time} • Khách hàng Khôi</Text>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          <Animated.View entering={FadeInDown.duration(400)} style={styles.modalSheet}>
            ...
            <View style={styles.modalTitleRow}>
              <Text style={styles.modalTitle}>Đặt lịch bảo dưỡng 📅</Text>
              <TouchableOpacity style={styles.closeBtn} onPress={() => logic.setBookingModalVisible(false)}>
                <Text style={{ color: Theme.colors.subtext, fontSize: 13, fontWeight: 'bold' }}>Đóng</Text>
              </TouchableOpacity>
            </View>
            
            <Text style={styles.modalSub}>Honda SH 160i (60-A1 555.55) • Showroom Biên Hòa</Text>

            {/* Date selection list */}
            <Text style={styles.bookingSectionTitle}>1. Chọn ngày đến xưởng:</Text>
            <View style={styles.bookingDateRow}>
              {[
                ...
                >
                  <Text style={[styles.bookingDateDayLabel, logic.selectedDate === item.date && styles.bookingDateTextActive]}>{item.label}</Text>
                  <Text style={[styles.bookingDateDayNumber, logic.selectedDate === item.date && styles.bookingDateTextActive]}>{item.day}</Text>
                  <Text style={[styles.bookingDateDayDesc, logic.selectedDate === item.date && styles.bookingDateTextActive]}>{item.desc}</Text>
                </TouchableOpacity>
              ))}
            </View>

            {/* Time selection list */}
            <Text style={styles.bookingSectionTitle}>2. Chọn khung giờ:</Text>
            <View style={styles.bookingTimeGrid}>
              {['08:00', '09:30', '11:00', '14:00', '15:30', '17:00'].map(time => (
                ...
                >
                  <Clock size={12} color={logic.selectedTime === time ? '#fff' : Theme.colors.subtext} style={{ marginRight: 6 }} />
                  <Text style={[styles.bookingTimeText, logic.selectedTime === time && styles.bookingTimeTextActive]}>{time}</Text>
                </TouchableOpacity>
              ))}
            </View>
