...
import { TrendingUp, Wallet, ArrowUpRight, ArrowDownRight } from 'lucide-react-native';
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        <Animated.View
          ...
          style={[styles.header, { marginTop: theme.spacing.xl + 20, marginBottom: 25 }]}
        >
          <Text
            style={[styles.title, { color: theme.colors.text, fontSize: 26, fontWeight: 'bold' }]}
          >
            Tài chính của tôi 💰
          </Text>
          <Text
            style={[styles.subtitle, { color: theme.colors.subtext, fontSize: 14, marginTop: 4 }]}
          >
            Quản lý tài sản & Giá trị thị trường
          </Text>
        </Animated.View>
          ...
          >
            <View style={styles.totalHeader}>
              ...
              <Text
                style={[
                  styles.totalLabel,
                  { color: theme.colors.subtext, fontSize: 13, marginLeft: 10 },
                ]}
              >
                Ước tính tổng giá trị tài sản
              </Text>
            </View>
            <Text
              style={[
            ...
            <View style={styles.trendRow}>
              ...
              <Text
                style={[
                  styles.trendText,
                  { color: theme.colors.success, fontSize: 12, fontWeight: 'bold', marginLeft: 8 },
                ]}
              >
          ...
          <Animated.View key={asset.id} entering={FadeInDown.delay(300 + index * 100)}>
            ...
            >
              <View style={styles.assetInfo}>
                <Text style={[styles.assetName, { color: theme.colors.subtext, fontSize: 13 }]}>
                  {asset.name}
                </Text>
                <Text
                  style={[
                    styles.assetValue,
                    { color: theme.colors.text, fontSize: 16, fontWeight: 'bold', marginTop: 4 },
                  ]}
                >
              ...
              <View
                style={[
                  styles.trendBadge,
                  {
                    ...
                    paddingVertical: 6,
                    borderRadius: 10,
                    backgroundColor: asset.trend.startsWith('+')
                      ? theme.colors.success + '1A'
                      : theme.colors.secondary + '1A',
                  },
                ]}
              >
                {asset.trend.startsWith('+') ? (
                  <ArrowUpRight size={12} color={theme.colors.success} />
                ) : (
                  <ArrowDownRight size={12} color={theme.colors.secondary} />
                )}
                <Text
                  style={[
                    styles.trendValue,
                    {
                      ...
                      fontWeight: 'bold',
                      marginLeft: 4,
                      color: asset.trend.startsWith('+')
                        ? Theme.staticColors.success
                        : Theme.staticColors.secondary,
                    },
                  ]}
                >
                  {asset.trend}
