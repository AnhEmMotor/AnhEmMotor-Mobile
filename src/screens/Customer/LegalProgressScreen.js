	...
	return (
		...
		>
			<Animated.View entering={FadeInUp.duration(600).delay(100)}>
				<Text style={[getStyles(theme).title, { color: theme.colors.text }]}>
					Tiến độ Pháp lý
				</Text>
				<View style={getStyles(theme).headerInfo}>
					<Text
						style={[getStyles(theme).bikeName, { color: theme.colors.primary }]}
					>
						Kawasaki Z1000
					</Text>
					<Text
						style={[
							getStyles(theme).bikePlate,
			...
			<Animated.View entering={FadeInUp.duration(800).delay(1000)}>
				...
				>
					<Text style={styles.infoText}>
						Hồ sơ của bạn đang được xử lý ưu tiên. Vui lòng chuẩn bị CCCD bản
						gốc khi đi bấm biển.
					</Text>
				</LinearGradient>
			</Animated.View>
