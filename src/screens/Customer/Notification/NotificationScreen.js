      ...
      case 'deliveryMap':
        return (
          <View>
            ...
            >
              ...
              <View
                style={[
                  ...
                  { width: '70%', backgroundColor: Theme.staticColors.warning },
                ]}
              />
              ...
              <View style={[styles.truckNode, { left: '55%' }]}>
                <Animated.View
                  ...
                  style={{
                    ...
                    marginBottom: 4,
                    borderWidth: 1,
                    borderColor: Theme.staticColors.warning,
                  }}
                >
                ...
                <Text
                  style={[
                    styles.nodeLabel,
                    { color: Theme.staticColors.warning, fontWeight: 'bold' },
                  ]}
                >
                  Đang chở
                </Text>
              ...
              <View style={styles.showroomNode}>
                ...
                <Text style={[styles.nodeLabel, { color: '#10B981', fontWeight: 'bold' }]}>
                  Biên Hòa
                </Text>
              </View>
              ...
              >
                ...
                >
                  GPS: Xe SH 160i cách Showroom 4.2 km
                </Text>
              </View>
            </View>
            <Text
            ...
            >
              Hệ thống vận tải của AnhEmMotor đang cập nhật hành trình vận chuyển xe máy từ tổng kho
              về Biên Hòa. Bạn có thể theo dõi xe tải trung chuyển cập bến trực tiếp để nhận bàn
              giao xe.
            </Text>
          </View>
        );
      ...
      case 'workshop':
        return (
          ...
          >
            ...
            >
              <Text style={[styles.workshopTitle, { color: '#10B981' }]}>
                Phiếu dịch vụ #SVC-55555
              </Text>
              <View
                style={{
                  backgroundColor: 'rgba(16, 185, 129, 0.15)',
              ...
              >
                <Text style={{ color: '#10B981', fontSize: moderateScale(9), fontWeight: '900' }}>
                  LIVE WORKSHOP
                </Text>
              </View>
            </View>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={[styles.techName, { color: activeColors.text }]}>
                  KTV. Nguyễn Văn Hùng
                </Text>
                <Text style={[styles.techTitle, { color: activeColors.subtext }]}>
                  Kỹ thuật viên trưởng bàn số 3
                </Text>
              </View>
              <View
                style={{
              ...
              >
                <Text style={{ color: '#10B981', fontSize: moderateScale(10), fontWeight: 'bold' }}>
                  Đang bảo dưỡng
                </Text>
              </View>
            </View>
            ...
            <View style={{ gap: 8 }}>
              {[
                ...
                {
                  name: '2. Lọc gió động cơ Honda chính hãng',
                  status: '✓ Đã thay',
                  color: '#10B981',
                },
                { name: '3. Vệ sinh buồng đốt & Kim phun', status: '✓ Đã thay', color: '#10B981' },
                {
                  name: '4. Kiểm tra nước làm mát & Điện ắc quy',
                  status: '⚙ Đang đo',
                ...
                >
                  <Text
                    style={[
                      styles.partName,
                      { color: activeColors.text, fontSize: moderateScale(11) },
                    ]}
                  >
                    {item.name}
                  </Text>
                  <Text
                    style={[
                      styles.partDone,
                      { color: item.color, fontSize: moderateScale(10), fontWeight: 'bold' },
                    ]}
                  >
                    {item.status}
                  </Text>
      ...
      case 'referral':
        return (
          <View style={{ alignItems: 'center' }}>
            ...
            >
              <Text style={[styles.couponLabel, { color: isDark ? '#818CF8' : '#6366F1' }]}>
              ...
              <Text
                style={[
                  styles.couponDesc,
                  { color: activeColors.subtext, fontSize: moderateScale(11), lineHeight: 16 },
                ]}
              >
                Bạn bè mua xe sử dụng mã này sẽ được giảm thẳng 500.000đ. Bản thân bạn sẽ được tặng
                ngay Voucher 500.000đ dịch vụ vào ví đặc quyền.
              </Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', width: '100%', marginBottom: 15, marginTop: 15 }}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Alert.alert('Thành công', 'Đã chia sẻ mã giới thiệu lên mạng xã hội!')
                }
              >
        ...
        return (
          <View style={{ alignItems: 'center', width: '100%' }}>
            ...
            >
              ...
              >
                QUÉT MÃ TẠI QUẦY GIAO DỊCH SHOWROOM
              </Text>
              ...
              >
                {[1, 3, 2, 1, 4, 2, 3, 1, 2, 4, 1, 2, 3, 2, 1, 3, 4, 1, 2, 3, 1, 2, 1, 3, 1].map(
                  (w, i) => (
                    <View
                      key={i}
                      style={[
                        styles.barcodeBar,
                        { width: w, backgroundColor: '#000000', height: '100%' },
                      ]}
                    />
                  )
                )}
              ...
              >
                {logic.selectedNotif.voucherCode || 'VOUCHER-9982'}
              </Text>
            </View>
            <Text
              style={[
            ...
            >
              Voucher được lưu tự động trong Ví ưu đãi của ứng dụng AnhEmMotor. Đưa mã vạch hoặc đọc
              mã trên cho nhân viên bán hàng để khấu trừ trực tiếp vào giá hóa đơn.
            </Text>
          </View>
        );
        ...
        return (
          <View>
            ...
            >
              ...
              >
                <Text style={[styles.invoiceLogo, { color: Theme.staticColors.primary }]}>
                  AnhEmMotor 🏍️
                </Text>
                <Text
                  style={[
                ...
                {[
                  ...
                  >
                    <Text
                      style={[
                        styles.invoiceLabel,
                        { color: activeColors.subtext, fontSize: moderateScale(11) },
                      ]}
                    >
                      {row.label}
                    </Text>
                    <Text
                      style={[
                        styles.invoiceVal,
                        {
                          color: row.color || activeColors.text,
                          fontSize: moderateScale(11),
                          fontWeight: 'bold',
                        },
                      ]}
              ...
              >
                ...
                <Text
                  style={[
                    styles.invoiceTotalVal,
                    { color: '#10B981', fontSize: moderateScale(16), fontWeight: 'bold' },
                  ]}
                >
                  {logic.selectedNotif.invoiceTotal || '105.000.000đ'}
                </Text>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert('Tải xuống', 'Hóa đơn đã được lưu dưới dạng PDF vào thư mục Downloads!')
              }
            >
          ...
          <View>
            <View
              style={[
                styles.letterPaper,
                {
                  backgroundColor: isDark ? '#1E1B4B' : '#FEFBF3',
                  borderWidth: 1,
                  borderColor: isDark ? 'rgba(99, 102, 241, 0.2)' : '#E5E0D8',
                  borderRadius: 16,
                  padding: 16,
                  marginBottom: 15,
                },
            ...
            >
              <View
                style={[
                  ...
                  {
                    borderBottomWidth: 1,
                    borderBottomColor: isDark ? 'rgba(255,255,255,0.06)' : '#EBE5DA',
                    paddingBottom: 8,
                    marginBottom: 12,
                  },
                ]}
              >
                ...
                <Text
                  style={[
                    styles.letterDate,
                    { color: activeColors.subtext, fontSize: moderateScale(10) },
                  ]}
                >
            ...
            >
              Góp ý của quý khách là động lực to lớn giúp AnhEmMotor cải tiến quy trình phục vụ ngày
              một tốt hơn.
            </Text>
          </View>
        );
          ...
          <View
            style={[
              styles.workshopCard,
              {
                ...
                backgroundColor: isDark ? 'rgba(59, 130, 246, 0.02)' : 'rgba(59, 130, 246, 0.05)',
              },
            ]}
          >
            <View
            ...
            >
              <Text style={[styles.workshopTitle, { color: '#E31B23' }]}>
            ...
            <View style={{ paddingVertical: 5, gap: 12 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                >
                  <Text style={{ color: '#fff', fontSize: moderateScale(10), fontWeight: 'bold' }}>
                    1
                  </Text>
                </View>
                <Text style={{ color: activeColors.subtext, fontSize: moderateScale(12), flex: 1 }}>
                  Khai thuế trước bạ online (Đã hoàn thành)
                </Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View
                ...
                >
                  Bấm biển số tại Biên Hòa (Đang tiến hành)
                </Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View
                ...
                >
                  <Text style={{ color: activeColors.subtext, fontSize: moderateScale(10) }}>
                    3
                  </Text>
                </View>
                <Text style={{ color: activeColors.subtext, fontSize: moderateScale(12), flex: 1 }}>
                  Lắp biển, rửa xe giao khách (Chờ xử lý)
                </Text>
              </View>
            </View>
          </View>
      ...
      case 'cleancar':
        return (
          <View style={{ alignItems: 'center', paddingVertical: 15 }}>
            ...
            >
              Hệ thống AnhEmMotor xác thực chiếc xe của bạn đã được kiểm tra, thay dầu chính hãng
              đầy đủ và cập nhật lịch trình chăm sóc kỹ thuật minh bạch trên Blockchain. Xe được cấp
              nhãn hiệu "Xe Sạch" nâng cao giá trị thanh lý sau này.
            </Text>
          </View>
        );
      ...
      case 'insurance':
        return (
          <View style={{ alignItems: 'center' }}>
            ...
            >
              Gia hạn bảo hiểm xe máy trực tuyến
            </Text>
            <Text
              style={{
                color: activeColors.subtext,
            ...
            >
              Chúng tôi liên kết trực tiếp với các đơn vị bảo hiểm uy tín (PVI, Bảo Việt, PJICO).
              Bạn có thể bấm nút tiếp tục thanh toán để nhận ngay giấy chứng nhận bảo hiểm điện tử
              trực tiếp trên app chỉ trong 2 phút.
            </Text>
            <TouchableOpacity
              style={[styles.modalActionBtn, { marginBottom: 15, height: 48, borderRadius: 12 }]}
              onPress={() =>
                Alert.alert('Thành công', 'Hệ thống đã mở liên kết cổng thanh toán Bảo hiểm PVI!')
              }
            >
              <Text style={[styles.modalActionText, { fontSize: moderateScale(13) }]}>
                Gia hạn ngay 🛡️
              </Text>
            </TouchableOpacity>
          </View>
      ...
      case 'security':
        return (
          <View style={{ alignItems: 'center' }}>
            ...
            >
              Mật khẩu tài khoản của bạn nên được cập nhật định kỳ để tăng tính an toàn, bảo vệ
              thông tin hóa đơn mua sắm và lịch sử bảo dưỡng xe tại AnhEmMotor.
            </Text>
            <TouchableOpacity
              style={[styles.modalActionBtn, { marginBottom: 15, height: 48, borderRadius: 12 }]}
              onPress={() =>
                Alert.alert('Thành công', 'Đã gửi mã OTP đổi mật khẩu về số điện thoại của bạn!')
              }
            >
              <Text style={[styles.modalActionText, { fontSize: moderateScale(13) }]}>
                Đổi mật khẩu mới 🔒
      ...
      <View style={styles.controlsRow}>
        <TouchableOpacity
          style={[
            ...
            logic.unreadOnly && styles.filterBadgeActive,
          ]}
        ...
        >
          <Text
            style={[
              ...
              { color: activeColors.subtext },
              logic.unreadOnly && styles.filterBadgeTextActive,
            ]}
          >
              ...
              <Text
                style={[
                  ...
                  isSelected && [
                    ...
                    { color: Theme.staticColors.primary, fontWeight: 'bold' },
                  ],
                ]}
              >
                {tab.label}
        ...
        {logic.activeTab === 'service' ? (
          ...
          <View>
            ...
            <Animated.View entering={FadeInDown.duration(500)} style={styles.loyaltyMemberCard}>
              <View style={styles.loyaltyMemberHeader}>
                ...
                >
                  ...
                  <Text
                    style={[styles.loyaltyMemberTitle, { flex: 1 }]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
            ...
            <Animated.View
              ...
              style={styles.loyaltyBirthdayCard}
            >
              <View style={styles.loyaltyBirthdayHeader}>
                ...
                >
                  ...
                  <Text
                    style={[styles.loyaltyBirthdayTitle, { flex: 1 }]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    Quà Tặng Sinh Nhật
              ...
              <View
                style={[
                  styles.birthdayGiftBox,
                  {
                    backgroundColor: isDark
                      ? 'rgba(236, 72, 153, 0.08)'
                      : 'rgba(236, 72, 153, 0.04)',
                    borderColor: isDark ? 'rgba(236, 72, 153, 0.1)' : 'rgba(236, 72, 153, 0.2)',
                  },
                ]}
              >
                <Text style={[styles.birthdayGiftTitle, { color: activeColors.text }]}>
                  Miễn phí thay nhớt máy tháng sinh nhật 🎂
                </Text>
                <Text style={[styles.birthdayGiftSub, { color: activeColors.subtext }]}>
                  Dành riêng cho chủ xe SH 160i
                </Text>
              </View>
            ...
            <Animated.View
              ...
              style={styles.loyaltyReferralCard}
            >
              <View style={styles.loyaltyReferralHeader}>
                ...
                >
                  ...
                  <Text
                    style={[styles.loyaltyReferralTitle, { flex: 1 }]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    Đồng Hành Giới Thiệu Xe
                  </Text>
                </View>
              ...
              <Text style={[styles.loyaltyReferralDesc, { color: activeColors.text }]}>
                Gửi mã giới thiệu của bạn cho bạn bè mua xe tại AnhEmMotor để cả hai cùng nhận
                Voucher 500.000đ dịch vụ.
              </Text>

              <TouchableOpacity
                style={[
                  styles.loyaltyCtaButton,
                  {
            ...
            <Animated.View entering={FadeInDown.duration(500)} style={styles.systemFeedbackCard}>
              <View style={styles.systemFeedbackHeader}>
                ...
                >
                  ...
                  />
                  <Text
                    style={[styles.systemFeedbackTitle, { flex: 1 }]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
              ...
              >
                <Text
                  style={[styles.feedbackParchmentBody, { color: activeColors.text, opacity: 0.8 }]}
                >
                  "Ban showroom AnhEmMotor Biên Hòa xin gửi lời cảm ơn và tiếp thu ý kiến đóng góp
                  chân thành của bạn. Chúng tôi đã xử lý nghiêm khắc sự cố..."
                </Text>
              </View>

              <Text style={[styles.systemFeedbackDesc, { color: activeColors.text }]}>
                Ban quản lý showroom đã chính thức phản hồi về góp ý của bạn ngày 15/05. Nhấn nút để
                xem toàn bộ nội dung cam kết chất lượng.
              </Text>
            ...
            >
              <View style={styles.systemFeedbackHeader}>
                ...
                >
                  ...
                  />
                  <Text
                    style={[styles.systemFeedbackTitle, { color: '#10B981', flex: 1 }]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    Góp ý về khu vực rửa xe
                  </Text>
                </View>
                <View
                  style={[
                    styles.feedbackBlueBadge,
                    { backgroundColor: 'rgba(16, 185, 129, 0.15)' },
                  ]}
                >
                  <Text style={[styles.feedbackBlueBadgeText, { color: '#10B981' }]}>
                    TẶNG VOUCHER 🧼
                  </Text>
                </View>
              </View>
              ...
              <View
                style={[
                  styles.feedbackParchmentPaper,
                  {
                    ...
                    borderColor: isDark ? 'rgba(16, 185, 129, 0.1)' : 'rgba(16, 185, 129, 0.3)',
                  },
                ]}
              >
                <Text
                  style={[
                    styles.feedbackParchmentBody,
              ...
              <Text style={[styles.systemFeedbackDesc, { color: activeColors.text }]}>
                Cảm ơn bạn đã đóng góp ý kiến về dịch vụ rửa xe sạch tại chi nhánh Biên Hòa. Đại lý
                đã ghi nhận và gửi tặng anh mã voucher rửa xe hoàn toàn miễn phí.
              </Text>
      ...
      >
        <View style={styles.modalOverlay}>
          <TouchableOpacity
            ...
            activeOpacity={1}
            onPress={() => logic.setActiveModal(null)}
          />
          <Animated.View
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            {}
            <Text style={[styles.bookingSectionTitle, { color: activeColors.text, marginTop: 5 }]}>
                ...
                >
                  <Text
                    style={[
                      ...
                      { color: logic.selectedDate === item.date ? '#fff' : activeColors.subtext },
                    ]}
                  >
                    {item.label}
                  </Text>
                  <Text
                    style={[
                      ...
                      { color: logic.selectedDate === item.date ? '#fff' : activeColors.text },
                    ]}
                  >
                    {item.day}
                  </Text>
            ...
            {}
            <Text style={[styles.bookingSectionTitle, { color: activeColors.text }]}>
              2. Chọn khung giờ:
            </Text>
            <View style={styles.bookingTimeGrid}>
              {['08:00', '09:30', '11:00', '14:00', '15:30', '17:00'].map((time) => (
                ...
                >
                  <Clock
                    size={12}
                    color={logic.selectedTime === time ? '#fff' : activeColors.subtext}
                    style={{ marginRight: 6 }}
                  />
                  <Text
                    style={[
