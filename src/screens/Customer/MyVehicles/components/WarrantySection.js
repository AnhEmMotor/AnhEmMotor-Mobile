  ...
  return (
    <View style={styles.openSection}>
      ...
      <View style={styles.warrantyMain}>
        <View>
          <Text style={[styles.warrantyLabel, { color: activeColors.subtext }]}>
            Bảo hành còn lại
          </Text>
          <Text style={[styles.warrantyDays, { color: activeColors.text }]}>
            {calculateWarrantyDays(bike.warrantyUntil)}{' '}
            <Text style={[styles.daysUnit, { color: activeColors.subtext }]}>ngày</Text>
          </Text>
        </View>
      ...
      <View style={[styles.insuranceSection, { backgroundColor: activeColors.card }]}>
        <View style={styles.insuranceHeader}>
          <View>
            <Text style={[styles.insuranceLabel, { color: activeColors.subtext }]}>
