...
export const styles = StyleSheet.create({
  ...
  filterBtn: { width: horizontalScale(48), height: horizontalScale(48), borderRadius: Theme.radius.md, backgroundColor: Theme.staticColors.primary, justifyContent: 'center', alignItems: 'center', marginLeft: horizontalScale(10) },
  ...
  chipText: { color: DEFAULT_SUBTEXT, fontSize: moderateScale(13), fontWeight: '500' },
  ...
  brandText: { color: DEFAULT_SUBTEXT, fontSize: moderateScale(12), fontWeight: '600' },
